    ...
    return (
        <div className="flex min-h-screen font-sans bg-[#f8fafc] overflow-hidden text-slate-900">
            ...
            <div className="hidden lg:flex w-[45%] bg-[#0a0f18] relative flex-col items-center justify-center p-16 text-white overflow-hidden">
                ...
                >
                    {/* Logo UNAB */}
                    <div className="mb-8 inline-flex items-center justify-center w-24 h-24 bg-white rounded-3xl shadow-[0_0_40px_rgba(59,130,246,0.15),0_20px_40px_rgba(0,0,0,0.3)] ring-1 ring-white/20">
                        <img src={logoUnab} alt="UNAB" className="w-20 h-auto" />
                    </div>

                    <h1 className="text-5xl font-black tracking-tighter mb-4">
                        Universidad <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-400">UNAB</span>
                    </h1>
